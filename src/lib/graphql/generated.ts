...
/** Registered schema for ACF Galerie 4 */
export type Acf_Galerie_4 = {
  __typename?: 'ACF_Galerie_4';
  /** Comment count. */
  ...
  /** Full file name. */
  fullFile?: Maybe<Scalars['String']['output']>;
  /** Full file size in bytes. */
  fullFileSize?: Maybe<Scalars['Int']['output']>;
  /** Full file URL. */
  fullFileUrl?: Maybe<Scalars['String']['output']>;
  /** Full file height. */
  fullHeight?: Maybe<Scalars['Int']['output']>;
  /** Full file mime type. */
  fullMimeType?: Maybe<Scalars['String']['output']>;
  /** Full file width. */
  fullWidth?: Maybe<Scalars['Int']['output']>;
  /** Attachment ID. */
  id?: Maybe<Scalars['String']['output']>;
  /** Large file name. */
  largeFullFile?: Maybe<Scalars['String']['output']>;
  /** Large file size in bytes. */
  largefullFileSize?: Maybe<Scalars['Int']['output']>;
  /** Large file URL. */
  largefullFileUrl?: Maybe<Scalars['String']['output']>;
  /** Large file height. */
  largefullHeight?: Maybe<Scalars['Int']['output']>;
  /** Large file mime type. */
  largefullMimeType?: Maybe<Scalars['String']['output']>;
  /** Large file width. */
  largefullWidth?: Maybe<Scalars['Int']['output']>;
  /** Medium file name. */
  mediumFullFile?: Maybe<Scalars['String']['output']>;
  /** Medium file size in bytes. */
  mediumfullFileSize?: Maybe<Scalars['Int']['output']>;
  /** Medium file URL. */
  mediumfullFileUrl?: Maybe<Scalars['String']['output']>;
  /** Medium file height. */
  mediumfullHeight?: Maybe<Scalars['Int']['output']>;
  /** Medium file mime type. */
  mediumfullMimeType?: Maybe<Scalars['String']['output']>;
  /** Medium file width. */
  mediumfullWidth?: Maybe<Scalars['Int']['output']>;
  /** Medium large file name. */
  mediumlargeFullFile?: Maybe<Scalars['String']['output']>;
  /** Medium large file size in bytes. */
  mediumlargefullFileSize?: Maybe<Scalars['Int']['output']>;
  /** Medium large file URL. */
  mediumlargefullFileUrl?: Maybe<Scalars['String']['output']>;
  /** Medium large file height. */
  mediumlargefullHeight?: Maybe<Scalars['Int']['output']>;
  /** Medium large file mime type. */
  mediumlargefullMimeType?: Maybe<Scalars['String']['output']>;
  /** Medium large file width. */
  mediumlargefullWidth?: Maybe<Scalars['Int']['output']>;
  /** Menu order. */
  menuOrder?: Maybe<Scalars['Int']['output']>;
  /** Ping status. */
  pingStatus?: Maybe<Scalars['String']['output']>;
  /** Pinged list. */
  pinged?: Maybe<Scalars['String']['output']>;
  /** Post author ID. */
  postAuthor?: Maybe<Scalars['Int']['output']>;
  /** Post content. */
  postContent?: Maybe<Scalars['String']['output']>;
  /** Filtered post content. */
  postContentFiltered?: Maybe<Scalars['String']['output']>;
  /** Post date. */
  postDate?: Maybe<Scalars['String']['output']>;
  /** Post date in GMT. */
  postDateGmt?: Maybe<Scalars['String']['output']>;
  /** Post excerpt. */
  postExcerpt?: Maybe<Scalars['String']['output']>;
  /** Post mime type. */
  postMimeType?: Maybe<Scalars['String']['output']>;
  /** Post modified date. */
  postModified?: Maybe<Scalars['String']['output']>;
  /** Post modified date in GMT. */
  postModifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Post name. */
  postName?: Maybe<Scalars['String']['output']>;
  /** Post parent ID. */
  postParent?: Maybe<Scalars['Int']['output']>;
  /** Post status. */
  postStatus?: Maybe<Scalars['String']['output']>;
  /** Post title. */
  postTitle?: Maybe<Scalars['String']['output']>;
  /** Post type. */
  postType?: Maybe<Scalars['String']['output']>;
  /** Thumbnail file name. */
  thumbnailFullFile?: Maybe<Scalars['String']['output']>;
  /** Thumbnail file size in bytes. */
  thumbnailfullFileSize?: Maybe<Scalars['Int']['output']>;
  /** Thumbnail file URL. */
  thumbnailfullFileUrl?: Maybe<Scalars['String']['output']>;
  /** Thumbnail file height. */
  thumbnailfullHeight?: Maybe<Scalars['Int']['output']>;
  /** Thumbnail file mime type. */
  thumbnailfullMimeType?: Maybe<Scalars['String']['output']>;
  /** Thumbnail file width. */
  thumbnailfullWidth?: Maybe<Scalars['Int']['output']>;
  /** To ping list. */
  toPing?: Maybe<Scalars['String']['output']>;
};
...
/** The payload for the createOrigin mutation. */
export type CreateOriginPayload = {
  __typename?: 'CreateOriginPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created origin */
  origin?: Maybe<Origin>;
...
/** The payload for the deleteOrigin mutation. */
export type DeleteOriginPayload = {
  __typename?: 'DeleteOriginPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']['output']>;
...
export type MenuItemObjectUnion = Category | Origin | Page | Post | PostFormat | Product | Tag;
...
/** The origin type */
export type Origin = DatabaseIdentifier & HierarchicalNode & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Origin';
  /** The ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors?: Maybe<OriginToAncestorsOriginConnection>;
  /** Connection between the origin type and its children origin. */
  children?: Maybe<OriginToOriginConnection>;
  /** Connection between the Origin type and the ContentNode type */
  contentNodes?: Maybe<OriginToContentNodeConnection>;
  /** The number of objects connected to the object */
  count?: Maybe<Scalars['Int']['output']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  ...
  /** Connection between the origin type and its parent origin. */
  parent?: Maybe<OriginToParentOriginConnectionEdge>;
  /** Database id of the parent node */
  parentDatabaseId?: Maybe<Scalars['Int']['output']>;
  /** The globally unique identifier of the parent node. */
  parentId?: Maybe<Scalars['ID']['output']>;
  /** Connection between the Origin type and the product type */
  products?: Maybe<OriginToProductConnection>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug?: Maybe<Scalars['String']['output']>;
  /** Connection between the Origin type and the Taxonomy type */
  taxonomy?: Maybe<OriginToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName?: Maybe<Scalars['String']['output']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId?: Maybe<Scalars['Int']['output']>;
...
/** The origin type */
export type OriginAncestorsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The origin type */
export type OriginChildrenArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<OriginToOriginConnectionWhereArgs>;
};


/** The origin type */
export type OriginContentNodesArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<OriginToContentNodeConnectionWhereArgs>;
};


/** The origin type */
export type OriginEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The origin type */
export type OriginEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
...
/** The origin type */
export type OriginProductsArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<OriginToProductConnectionWhereArgs>;
};

/** A paginated collection of origin Nodes, Supports cursor-based pagination and filtering to efficiently retrieve sets of origin Nodes */
export type OriginConnection = {
  /** A list of edges (relational context) between RootQuery and connected origin Nodes */
  edges: Array<OriginConnectionEdge>;
  /** A list of connected origin Nodes */
  nodes: Array<Origin>;
  /** Information about pagination in a connection. */
  pageInfo: OriginConnectionPageInfo;
};

/** Represents a connection to a origin. Contains both the origin Node and metadata about the relationship. */
export type OriginConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The connected origin Node */
  node: Origin;
};

/** Pagination metadata specific to &quot;OriginConnectionEdge&quot; collections. Provides cursors and flags for navigating through sets of &quot;OriginConnectionEdge&quot; Nodes. */
export type OriginConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Origin type and the origin type */
export type OriginToAncestorsOriginConnection = Connection & OriginConnection & {
  __typename?: 'OriginToAncestorsOriginConnection';
  /** Edges for the OriginToAncestorsOriginConnection connection */
  edges: Array<OriginToAncestorsOriginConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Origin>;
  /** Information about pagination in a connection. */
  pageInfo: OriginToAncestorsOriginConnectionPageInfo;
};

/** An edge in a connection */
export type OriginToAncestorsOriginConnectionEdge = Edge & OriginConnectionEdge & {
  __typename?: 'OriginToAncestorsOriginConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Origin;
...
/** Pagination metadata specific to &quot;OriginToAncestorsOriginConnection&quot; collections. Provides cursors and flags for navigating through sets of OriginToAncestorsOriginConnection Nodes. */
export type OriginToAncestorsOriginConnectionPageInfo = OriginConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'OriginToAncestorsOriginConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Origin type and the ContentNode type */
export type OriginToContentNodeConnection = Connection & ContentNodeConnection & {
  __typename?: 'OriginToContentNodeConnection';
  /** Edges for the OriginToContentNodeConnection connection */
  edges: Array<OriginToContentNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ContentNode>;
  /** Information about pagination in a connection. */
  pageInfo: OriginToContentNodeConnectionPageInfo;
};

/** An edge in a connection */
export type OriginToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
  __typename?: 'OriginToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ContentNode;
...
/** Pagination metadata specific to &quot;OriginToContentNodeConnection&quot; collections. Provides cursors and flags for navigating through sets of OriginToContentNodeConnection Nodes. */
export type OriginToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'OriginToContentNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Origin type and the origin type */
export type OriginToOriginConnection = Connection & OriginConnection & {
  __typename?: 'OriginToOriginConnection';
  /** Edges for the OriginToOriginConnection connection */
  edges: Array<OriginToOriginConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Origin>;
  /** Information about pagination in a connection. */
  pageInfo: OriginToOriginConnectionPageInfo;
};

/** An edge in a connection */
export type OriginToOriginConnectionEdge = Edge & OriginConnectionEdge & {
  __typename?: 'OriginToOriginConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Origin;
...
/** Pagination metadata specific to &quot;OriginToOriginConnection&quot; collections. Provides cursors and flags for navigating through sets of OriginToOriginConnection Nodes. */
export type OriginToOriginConnectionPageInfo = OriginConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'OriginToOriginConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Origin type and the origin type */
export type OriginToParentOriginConnectionEdge = Edge & OneToOneConnection & OriginConnectionEdge & {
  __typename?: 'OriginToParentOriginConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Origin;
...
/** Connection between the Origin type and the product type */
export type OriginToProductConnection = Connection & ProductConnection & {
  __typename?: 'OriginToProductConnection';
  /** Edges for the OriginToProductConnection connection */
  edges: Array<OriginToProductConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Product>;
  /** Information about pagination in a connection. */
  pageInfo: OriginToProductConnectionPageInfo;
};

/** An edge in a connection */
export type OriginToProductConnectionEdge = Edge & ProductConnectionEdge & {
  __typename?: 'OriginToProductConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Product;
...
/** Pagination metadata specific to &quot;OriginToProductConnection&quot; collections. Provides cursors and flags for navigating through sets of OriginToProductConnection Nodes. */
export type OriginToProductConnectionPageInfo = PageInfo & ProductConnectionPageInfo & WpPageInfo & {
  __typename?: 'OriginToProductConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Origin type and the Taxonomy type */
export type OriginToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
  __typename?: 'OriginToTaxonomyConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Taxonomy;
...
/** The product type */
export type Product = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & WithAcfProductDetail & {
  __typename?: 'Product';
  /**
   * The ancestors of the content node.
   * @deprecated This content type is not hierarchical and typically will not have ancestors
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']['output']>;
  /** Whether the products object is password protected. */
  hasPassword?: Maybe<Scalars['Boolean']['output']>;
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']['output']>;
  /** Connection between the Product type and the origin type */
  origin?: Maybe<ProductToOriginConnection>;
  /**
   * The parent of the content node.
   * @deprecated This content type is not hierarchical and typically will not have a parent
   */
  parent?: Maybe<ProductToParentConnectionEdge>;
  /** The password for the products object. */
  password?: Maybe<Scalars['String']['output']>;
...
/** The product type */
export type ProductOriginArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<ProductToOriginConnectionWhereArgs>;
};
...
/** The &quot;ProductDetail&quot; Field Group. Added to the Schema by &quot;WPGraphQL for ACF&quot;. */
export type ProductDetail = AcfFieldGroup & AcfFieldGroupFields & ProductDetail_Fields & {
  __typename?: 'ProductDetail';
  /** Field of the &quot;radio&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  condition?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  englishDescription?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  farsiDescription?: Maybe<Scalars['String']['output']>;
  /**
   * The name of the field group
   * @deprecated Use __typename instead
   */
  fieldGroupName?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;galerie-4&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  gallery?: Maybe<Array<Maybe<Acf_Galerie_4>>>;
  /** Field of the &quot;number&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  length?: Maybe<Scalars['Float']['output']>;
  /** Field of the &quot;radio&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  pile?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;number&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  price?: Maybe<Scalars['Float']['output']>;
  /** Field of the &quot;checkbox&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  soldOut?: Maybe<Array<Maybe<Scalars['String']['output']>>>;
  /** Field of the &quot;radio&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  type?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;radio&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  warp?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;radio&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  weft?: Maybe<Scalars['String']['output']>;
  /** example: 25 */
...
/** Interface representing fields of the ACF &quot;ProductDetail&quot; Field Group */
export type ProductDetail_Fields = {
  /** Field of the &quot;radio&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  condition?: Maybe<Scalars['String']['output']>;
  /** Field of the &quot;wysiwyg&quot; Field Type added to the schema as part of the &quot;ProductDetail&quot; Field Group */
  englishDescription?: Maybe<Scalars['String']['output']>;
...
/** Connection between the Product type and the origin type */
export type ProductToOriginConnection = Connection & OriginConnection & {
  __typename?: 'ProductToOriginConnection';
  /** Edges for the ProductToOriginConnection connection */
  edges: Array<ProductToOriginConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Origin>;
  /** Information about pagination in a connection. */
  pageInfo: ProductToOriginConnectionPageInfo;
};

/** An edge in a connection */
export type ProductToOriginConnectionEdge = Edge & OriginConnectionEdge & {
  __typename?: 'ProductToOriginConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Origin;
...
/** Pagination metadata specific to &quot;ProductToOriginConnection&quot; collections. Provides cursors and flags for navigating through sets of ProductToOriginConnection Nodes. */
export type ProductToOriginConnectionPageInfo = OriginConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'ProductToOriginConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
export type RootMutation = {
  ...
  /** The createOrigin mutation */
  createOrigin?: Maybe<CreateOriginPayload>;
  ...
  /** The deleteOrigin mutation */
  deleteOrigin?: Maybe<DeleteOriginPayload>;
  ...
  /** The updateOrigin mutation */
  updateOrigin?: Maybe<UpdateOriginPayload>;
...
/** The root mutation */
export type RootMutationCreateOriginArgs = {
...
/** The root mutation */
export type RootMutationDeleteOriginArgs = {
...
/** The root mutation */
export type RootMutationUpdateOriginArgs = {
...
export type RootQuery = {
  ...
  /** Connection between the RootQuery type and the origin type */
  allOrigin?: Maybe<RootQueryToOriginConnection>;
...
/** The root entry point into the Graph */
export type RootQueryAllOriginArgs = {
  after?: InputMaybe<Scalars['String']['input']>;
  before?: InputMaybe<Scalars['String']['input']>;
  first?: InputMaybe<Scalars['Int']['input']>;
  last?: InputMaybe<Scalars['Int']['input']>;
  where?: InputMaybe<RootQueryToOriginConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryOriginArgs = {
  id: Scalars['ID']['input'];
  idType?: InputMaybe<OriginIdType>;
};
...
/** Connection between the RootQuery type and the origin type */
export type RootQueryToOriginConnection = Connection & OriginConnection & {
  __typename?: 'RootQueryToOriginConnection';
  /** Edges for the RootQueryToOriginConnection connection */
  edges: Array<RootQueryToOriginConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Origin>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToOriginConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToOriginConnectionEdge = Edge & OriginConnectionEdge & {
  __typename?: 'RootQueryToOriginConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Origin;
...
/** Pagination metadata specific to &quot;RootQueryToOriginConnection&quot; collections. Provides cursors and flags for navigating through sets of RootQueryToOriginConnection Nodes. */
export type RootQueryToOriginConnectionPageInfo = OriginConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToOriginConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor?: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The payload for the updateOrigin mutation. */
export type UpdateOriginPayload = {
  __typename?: 'UpdateOriginPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  /** The created origin */
  origin?: Maybe<Origin>;
...
/** Provides access to fields of the &quot;ProductDetail&quot; ACF Field Group via the &quot;productDetail&quot; field */
export type WithAcfProductDetail = {
  /** Fields of the ProductDetail ACF Field Group */
  productDetail?: Maybe<ProductDetail>;
};
...
export type GetOriginsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetOriginsQuery = { __typename?: 'RootQuery', allOrigin?: { __typename?: 'RootQueryToOriginConnection', edges: Array<{ __typename?: 'RootQueryToOriginConnectionEdge', node: { __typename?: 'Origin', id: string, databaseId: number, name?: string | null, slug?: string | null, parentDatabaseId?: number | null } }> } | null };
...
export type GetProductsQuery = { __typename?: 'RootQuery', products?: { __typename?: 'RootQueryToProductConnection', pageInfo: { __typename?: 'RootQueryToProductConnectionPageInfo', hasNextPage: boolean, endCursor?: string | null }, edges: Array<{ __typename?: 'RootQueryToProductConnectionEdge', node: { __typename?: 'Product', id: string, databaseId: number, title?: string | null, slug?: string | null, featuredImage?: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl?: string | null, altText?: string | null } } | null, productDetail?: { __typename?: 'ProductDetail', price?: number | null, condition?: string | null, soldOut?: Array<string | null> | null, type?: string | null, width?: number | null, length?: number | null } | null, origin?: { __typename?: 'ProductToOriginConnection', edges: Array<{ __typename?: 'ProductToOriginConnectionEdge', node: { __typename?: 'Origin', id: string, databaseId: number, name?: string | null, slug?: string | null, parent?: { __typename?: 'OriginToParentOriginConnectionEdge', node: { __typename?: 'Origin', id: string, databaseId: number, name?: string | null, slug?: string | null } } | null } }> } | null } }> } | null };

export type GetSiteSettingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSiteSettingsQuery = { __typename?: 'RootQuery', generalSettings?: { __typename?: 'GeneralSettings', title?: string | null, description?: string | null, url?: string | null } | null };


export const GetOriginsDocument = gql`
    query GetOrigins {
  allOrigin(first: 100, where: {hideEmpty: true}) {
    edges {
      node {
        id
        databaseId
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetOrigins(variables?: GetOriginsQueryVariables, requestHeaders?: GraphQLClientRequestHeaders, signal?: RequestInit['signal']): Promise<GetOriginsQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetOriginsQuery>({ document: GetOriginsDocument, variables, requestHeaders: { ...requestHeaders, ...wrappedRequestHeaders }, signal }), 'GetOrigins', 'query', variables);
    },
